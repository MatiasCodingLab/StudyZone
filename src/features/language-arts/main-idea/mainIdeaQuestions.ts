...
// true-but-small supporting detail, a too-broad claim, and a misinterpreted
// (unsupported) claim.
//
// Answer-choice rules (see questionQuality.ts for the automated check):
//   - Keep all 4 choices roughly the same length/word count. The correct
//     answer must never be identifiable just because it's the longest or
//     most detailed option.
//   - Don't rely on absolute-word "tells" (always/every/only/most) to make a
//     distractor obviously wrong on grade-level and challenge questions -
//     make it believable enough that a student has to check it against the
//     passage.
//   - The main idea should summarize most of the passage without standing
//     out stylistically from the distractors.
    ...
    choices: [
      {
        id: 'a',
        type: 'main-idea',
        text: 'On Fridays, the class picks new books and hears a short story.',
        feedback: 'This combines the choosing of books and the story time, which are both described.',
      },
      {
        id: 'b',
        type: 'supporting-detail',
        text: 'Students in the class can choose two books to take home.',
        feedback: 'True, but this only covers part of what happens on library day.',
      },
      {
        id: 'c',
        type: 'too-broad',
        text: 'Reading for fun is considered the best way to spend free time.',
        feedback: 'This is a bigger claim than what the passage actually says.',
      },
      {
        id: 'd',
        type: 'unsupported',
        text: 'Mr. Alvarez is considered the favorite teacher of every student.',
    ...
    choices: [
      {
        id: 'a',
        type: 'main-idea',
        text: 'Coach Diaz uses the same practice routine to help players improve.',
        feedback: 'This ties together the stretching, drills, and scrimmage as one plan for progress.',
      },
      {
        id: 'b',
        type: 'supporting-detail',
        text: 'Near the end of practice, players scrimmage together in small teams.',
        feedback: 'True, but that is only one part of the whole practice routine.',
      },
      {
        id: 'c',
        type: 'too-broad',
        text: 'Coach Diaz runs the best basketball program in the entire state.',
        feedback: 'The passage doesn\u2019t say anything about other coaches or the whole state.',
      },
      {
        id: 'd',
        type: 'unsupported',
        text: 'The team has won every single game it has played this year.',
  ...
  },
  {
    ...
    choices: [
      ...
      },
      {
        id: 'd',
        type: 'unsupported',
        text: 'Rainbows can only be seen early in the morning sky.',
    ...
    choices: [
      {
        id: 'a',
        type: 'main-idea',
        text: 'Maya and her grandmother work together all summer to grow a garden.',
        feedback: 'This connects the planting, watering, and sharing described in the passage.',
      },
      {
        id: 'b',
        type: 'supporting-detail',
        text: 'Maya waters the plants in the garden every single morning.',
        feedback: 'True, but watering is just one job Maya does.',
      },
      {
        id: 'c',
        type: 'too-broad',
        text: 'Gardening is considered the most rewarding hobby a family can share.',
        feedback: 'The passage never makes a claim about all families or hobbies.',
      },
      {
        id: 'd',
        type: 'unsupported',
        text: 'Maya\u2019s grandmother sells their vegetables at the local farmer\u2019s market.',
    ...
    choices: [
      {
        id: 'a',
        type: 'main-idea',
        text: 'Bees and flowers depend on one another in order to survive.',
        feedback: 'This captures the two-way relationship described across the whole passage.',
      },
      {
        id: 'b',
        type: 'supporting-detail',
        text: 'Bees use the nectar they collect from flowers to make honey.',
        feedback: 'True, but that only covers one part of what bees do.',
      },
      {
        id: 'c',
        type: 'too-broad',
        text: 'All insects play an equally important role in helping plants grow.',
        feedback: 'The passage only discusses bees, not every insect.',
      },
      {
        id: 'd',
        type: 'unsupported',
        text: 'Flowers are never able to make seeds without help from bees.',
    ...
    choices: [
      {
        id: 'a',
        type: 'main-idea',
        text: 'Making bread requires several careful steps that must happen in order.',
        feedback: 'This reflects the whole process, not just one step.',
      },
      {
        id: 'b',
        type: 'supporting-detail',
        text: 'The dough needs time to rise before it gets shaped into loaves.',
        feedback: 'True, but rising is just one step in the process.',
      },
      {
        id: 'c',
        type: 'too-broad',
        text: 'Baking is considered the most difficult kind of cooking there is.',
        feedback: 'The passage never compares baking to other kinds of cooking.',
      },
      {
        id: 'd',
        type: 'unsupported',
        text: 'Bakers always use the exact same recipe every time they bake.',
    ...
    choices: [
      {
        id: 'a',
        type: 'main-idea',
        text: 'Baby sea turtles face a dangerous trip from their nest to the sea.',
        feedback: 'This sums up the whole hatching and crawling journey.',
      },
      {
        id: 'b',
        type: 'supporting-detail',
        text: 'Baby turtles dig their way out of the sand during the night.',
        feedback: 'True, but this is only the first part of their journey.',
      },
      {
        id: 'c',
        type: 'too-broad',
        text: 'Every kind of ocean animal lives an extremely difficult and short life.',
        feedback: 'The passage only talks about sea turtles, not ocean animals in general.',
      },
      {
        id: 'd',
        type: 'unsupported',
        text: 'Most baby turtles get eaten before they ever reach the ocean water.',
    ...
    choices: [
      {
        id: 'a',
        type: 'main-idea',
        text: 'Recess gives students many different ways to relax and have fun.',
        feedback: 'This covers the variety of activities and the overall purpose of recess.',
      },
      {
        id: 'b',
        type: 'supporting-detail',
        text: 'Some students at Lincoln Elementary play tag or jump rope outside.',
        feedback: 'True, but this only names a couple of the possible activities.',
      },
      {
        id: 'c',
        type: 'too-broad',
        text: 'Playing outside is considered the single healthiest activity for kids.',
        feedback: 'The passage doesn\u2019t make any claim about health.',
      },
      {
        id: 'd',
        type: 'unsupported',
        text: 'Every student at Lincoln Elementary plays on the climbing wall daily.',
    ...
    choices: [
      {
        id: 'a',
        type: 'main-idea',
        text: 'The Chen family sorts their trash carefully to throw away less garbage.',
        feedback: 'This connects the sorting system with its overall result.',
      },
      {
        id: 'b',
        type: 'supporting-detail',
        text: 'Food scraps from the Chen family go into their compost bin.',
        feedback: 'True, but this is just one part of their sorting system.',
      },
      {
        id: 'c',
        type: 'too-broad',
        text: 'Recycling at home can solve the entire world\u2019s garbage problem.',
        feedback: 'The passage only talks about one family\u2019s habits, not the whole world.',
      },
      {
        id: 'd',
        type: 'unsupported',
        text: 'The Chen family has been recycling this way for over ten years.',
    ...
    choices: [
      {
        id: 'a',
        type: 'main-idea',
        text: 'Relay riders on fast horses helped the Pony Express deliver mail quickly.',
        feedback: 'This ties together the relay system, the riders, and the speed improvement described.',
      },
      {
        id: 'b',
        type: 'supporting-detail',
        text: 'At each station, a tired rider would jump onto a fresh horse.',
        feedback: 'True, but this describes only one part of how the system worked.',
      },
      {
        id: 'c',
        type: 'too-broad',
        text: 'Horses were the main form of transportation for every task in the 1800s.',
        feedback: 'The passage only discusses mail delivery, not all transportation.',
      },
      {
        id: 'd',
        type: 'unsupported',
        text: 'The Pony Express ran successfully for many years before finally closing down.',
    ...
    choices: [
      {
        id: 'a',
        type: 'main-idea',
        text: 'Water keeps moving between the Earth and sky in a repeating cycle.',
        feedback: 'This describes the overall cycle, not just one stage of it.',
      },
      {
        id: 'b',
        type: 'supporting-detail',
        text: 'Rising water vapor cools down and forms clouds through condensation.',
        feedback: 'True, but this is only one stage of the whole cycle.',
      },
      {
        id: 'c',
        type: 'too-broad',
        text: 'The sun controls every natural process that happens here on Earth.',
        feedback: 'The passage only talks about the water cycle, not everything the sun does.',
      },
      {
        id: 'd',
        type: 'unsupported',
        text: 'Rain always falls in the exact same place where it evaporated.',
    ...
    choices: [
      {
        id: 'a',
        type: 'main-idea',
        text: 'George Washington Carver helped farmers by finding new crops and their many uses.',
        feedback: 'This connects his research, the new crops, and how farmers benefited.',
      },
      {
        id: 'b',
        type: 'supporting-detail',
        text: 'Carver is remembered for inventing over a hundred uses for the peanut.',
        feedback: 'True, but this is just one part of his overall work with farmers.',
      },
      {
        id: 'c',
        type: 'too-broad',
        text: 'Carver became known as the most important scientist in American history.',
        feedback: 'The passage never compares Carver to other scientists or claims he was the most famous.',
      },
      {
        id: 'd',
        type: 'unsupported',
        text: 'Carver spent his childhood years working on his family\u2019s peanut farm.',
    ...
    choices: [
      {
        id: 'a',
        type: 'main-idea',
        text: 'Edison improved the light bulb and made electric light practical for daily use.',
        feedback: 'This includes both his testing process and the power stations that made the invention usable.',
      },
      {
        id: 'b',
        type: 'supporting-detail',
        text: 'One material Edison tested, a carbonized cotton thread, burned for over thirteen hours.',
        feedback: 'True, but this only describes one discovery along the way.',
      },
      {
        id: 'c',
        type: 'too-broad',
        text: 'Thomas Edison is credited with inventing nearly every piece of modern technology.',
        feedback: 'The passage only discusses the lightbulb, not all modern technology.',
      },
      {
        id: 'd',
        type: 'unsupported',
        text: 'Edison worked entirely alone for years while inventing the electric light bulb.',
    ...
    choices: [
      {
        id: 'a',
        type: 'main-idea',
        text: 'Marathon runners need months of steady training to prepare their bodies for race day.',
        feedback: 'This connects the mileage, pacing, and rest described throughout the passage.',
      },
      {
        id: 'b',
        type: 'supporting-detail',
        text: 'Rest days are included in training so runners\u2019 muscles can recover fully.',
        feedback: 'True, but rest days are just one part of the whole training plan.',
      },
      {
        id: 'c',
        type: 'too-broad',
        text: 'Running is widely considered to be the healthiest sport a person can do.',
        feedback: 'The passage never compares running to other sports.',
      },
      {
        id: 'd',
        type: 'unsupported',
        text: 'Most runners are able to finish a marathon in under three hours.',
    ...
    choices: [
      {
        id: 'a',
        type: 'main-idea',
        text: 'It takes several butterfly generations to complete the monarch migration each year.',
        feedback: 'This ties together the distance, the generations, and the destination described.',
      },
      {
        id: 'b',
        type: 'supporting-detail',
        text: 'Millions of monarch butterflies cluster together on trees once they reach Mexico.',
        feedback: 'True, but this only describes what happens once they arrive.',
      },
      {
        id: 'c',
        type: 'too-broad',
        text: 'Every species of butterfly migrates long distances at least once a year.',
        feedback: 'The passage only describes monarch butterflies, not all butterflies.',
      },
      {
        id: 'd',
        type: 'unsupported',
        text: 'Monarch butterflies remember the exact trip they made the year before.',
    ...
    choices: [
      {
        id: 'a',
        type: 'main-idea',
        text: 'Coral reefs support huge amounts of ocean life but face threats from warming water.',
        feedback: 'This connects both the importance of reefs and the danger they face.',
      },
      {
        id: 'b',
        type: 'supporting-detail',
        text: 'Coral polyps slowly build the hard skeletons that form massive reef structures.',
        feedback: 'True, but this describes only how reefs are built, not the whole passage.',
      },
      {
        id: 'c',
        type: 'too-broad',
        text: 'The ocean is considered the single most important habitat found on Earth.',
        feedback: 'The passage focuses on coral reefs specifically, not the entire ocean.',
      },
      {
        id: 'd',
        type: 'unsupported',
        text: 'Coral bleaching has already wiped out most of the world\u2019s coral reefs.',
    ...
    choices: [
      {
        id: 'a',
        type: 'main-idea',
        text: 'The science fair lets students practice the full process of scientific investigation.',
        feedback: 'This reflects the whole process from question to presentation described in the passage.',
      },
      {
        id: 'b',
        type: 'supporting-detail',
        text: 'Judges walk around asking students questions about their projects on fair day.',
        feedback: 'True, but this only describes one part of fair day.',
      },
      {
        id: 'c',
        type: 'too-broad',
        text: 'Science fairs are considered the best way for any student to learn science.',
        feedback: 'This is a bigger claim than the passage supports; it only discusses one school\u2019s experience.',
      },
      {
        id: 'd',
        type: 'unsupported',
        text: 'Every student who enters the Riverside science fair wins some kind of award.',
    ...
    choices: [
      {
        id: 'a',
        type: 'main-idea',
        text: 'Firefighters keep communities safe by handling many different kinds of emergencies.',
        feedback: 'This covers the full range of duties described, not just one.',
      },
      {
        id: 'b',
        type: 'supporting-detail',
        text: 'Firefighters regularly check that fire exits and alarms in buildings are working.',
        feedback: 'True, but this is just one of their many responsibilities.',
      },
      {
        id: 'c',
        type: 'too-broad',
        text: 'Firefighters are considered the most essential workers found in any community.',
        feedback: 'The passage never compares firefighters to other community workers.',
      },
      {
        id: 'd',
        type: 'unsupported',
        text: 'Rescuing trapped animals takes up most of a firefighter\u2019s normal working day.',
    ...
    choices: [
      {
        id: 'a',
        type: 'main-idea',
        text: 'The ISS lets astronauts from many countries live and do research together.',
        feedback: 'This connects the international teamwork with the purpose of the station\u2019s research.',
      },
      {
        id: 'b',
        type: 'supporting-detail',
        text: 'Astronauts must strap themselves down to sleep because gravity is nearly absent.',
        feedback: 'True, but this is just one detail about daily life aboard the station.',
      },
      {
        id: 'c',
        type: 'too-broad',
        text: 'Space travel will soon make it possible for humans to live on Mars.',
        feedback: 'The passage mentions future missions but doesn\u2019t claim humans will soon live on Mars.',
      },
      {
        id: 'd',
        type: 'unsupported',
        text: 'The ISS travels faster than any other object ever built by people.',
    ...
    choices: [
      {
        id: 'a',
        type: 'main-idea',
        text: 'Deep-sea creatures have unusual adaptations that help them survive in dark, scarce-food water.',
        feedback: 'This connects the bioluminescence and eating adaptations as ways creatures survive the deep sea.',
      },
      {
        id: 'b',
        type: 'supporting-detail',
        text: 'Some deep-sea creatures have grown huge mouths and stomachs to eat any meal.',
        feedback: 'True, but this is only one adaptation mentioned in the passage.',
      },
      {
        id: 'c',
        type: 'too-broad',
        text: 'Humans have explored more of outer space than of Earth\u2019s own oceans.',
        feedback: 'The passage only compares the deep ocean to the Moon, not to outer space or every ocean.',
      },
      {
        id: 'd',
        type: 'unsupported',
        text: 'Every single deep-sea creature is able to create its own light.',
    ...
    choices: [
      {
        id: 'a',
        type: 'main-idea',
        text: 'The Venus flytrap traps insects to get nutrients its poor soil cannot give.',
        feedback: 'This ties together why the plant traps insects and how the whole process works.',
      },
      {
        id: 'b',
        type: 'supporting-detail',
        text: 'The flytrap\u2019s trap snaps shut once an insect touches two hairs quickly.',
        feedback: 'True, but this only explains how the trap is triggered, not the whole passage.',
      },
      {
        id: 'c',
        type: 'too-broad',
        text: 'Every plant that grows in poor soil has evolved to eat insects.',
        feedback: 'The passage only discusses the Venus flytrap, not all plants in poor soil.',
      },
      {
        id: 'd',
        type: 'unsupported',
        text: 'The Venus flytrap is able to catch insects far larger than itself.',
    ...
    choices: [
      {
        id: 'a',
        type: 'main-idea',
        text: 'Hurricanes form over warm water and get tracked closely so towns can prepare.',
        feedback: 'This connects how hurricanes form with why tracking them matters.',
      },
      {
        id: 'b',
        type: 'supporting-detail',
        text: 'Meteorologists fly special aircraft directly into storms to measure conditions inside.',
        feedback: 'True, but this is only one part of how hurricanes are tracked.',
      },
      {
        id: 'c',
        type: 'too-broad',
        text: 'Hurricanes are considered the most dangerous weather event found anywhere on Earth.',
        feedback: 'The passage never compares hurricanes to other kinds of weather.',
      },
      {
        id: 'd',
        type: 'unsupported',
        text: 'Every hurricane that forms over the ocean eventually reaches land somewhere.',
    ...
    choices: [
      {
        id: 'a',
        type: 'main-idea',
        text: 'Workers built the railroad to connect the country and shorten travel time greatly.',
        feedback: 'This connects the building effort with the major result of faster travel.',
      },
      {
        id: 'b',
        type: 'supporting-detail',
        text: 'A golden spike was driven into the ground in Utah back in 1869.',
        feedback: 'True, but this describes only the finishing celebration, not the whole story.',
      },
      {
        id: 'c',
        type: 'too-broad',
        text: 'Railroads changed transportation completely in every country around the entire world.',
        feedback: 'The passage only discusses this one railroad in the United States.',
      },
      {
        id: 'd',
        type: 'unsupported',
        text: 'Only Chinese immigrants worked on building the entire Transcontinental Railroad.',
    ...
    choices: [
      {
        id: 'a',
        type: 'main-idea',
        text: 'Harvest festivals from many cultures helped shape today\u2019s Thanksgiving traditions over time.',
        feedback: 'This connects the historical festivals with how they influenced modern Thanksgiving.',
      },
      {
        id: 'b',
        type: 'supporting-detail',
        text: 'Families at harvest gatherings often shared foods like fresh corn and squash.',
        feedback: 'True, but this only describes one detail of the festivals.',
      },
      {
        id: 'c',
        type: 'too-broad',
        text: 'Every single holiday celebrated in America came from an old harvest festival.',
        feedback: 'The passage only discusses Thanksgiving, not every American holiday.',
      },
      {
        id: 'd',
        type: 'unsupported',
        text: 'Modern Thanksgiving celebrations are exactly identical to the earliest harvest festivals.',
    ...
    choices: [
      {
        id: 'a',
        type: 'main-idea',
        text: 'Lovelace\u2019s notes described an early computer program, later earning her lasting recognition.',
        feedback: 'This connects her notes, the ideas within them, and the lasting recognition she received.',
      },
      {
        id: 'b',
        type: 'supporting-detail',
        text: 'Lovelace\u2019s added notes ended up several times longer than the original article.',
        feedback: 'True, but this only describes the length of her writing, not why it mattered.',
      },
      {
        id: 'c',
        type: 'too-broad',
        text: 'Ada Lovelace is generally credited with building the world\u2019s first working computer.',
        feedback: 'The passage says the machine was never fully built in her lifetime, so she did not build a working computer.',
      },
      {
        id: 'd',
        type: 'unsupported',
        text: 'Babbage and Lovelace successfully built a working version of the Analytical Engine.',
    ...
    choices: [
      {
        id: 'a',
        type: 'main-idea',
        text: 'The Great Wall was connected and extended over centuries using varied local materials.',
        feedback: 'This reflects the long history and varied construction described throughout the passage.',
      },
      {
        id: 'b',
        type: 'supporting-detail',
        text: 'Builders used stone in the mountains and packed earth out on the plains.',
        feedback: 'True, but this only explains one detail about materials, not the whole history of the wall.',
      },
      {
        id: 'c',
        type: 'too-broad',
        text: 'The Great Wall is generally regarded as the greatest achievement in human history.',
        feedback: 'The passage never makes a comparison to all human achievements.',
      },
      {
        id: 'd',
        type: 'unsupported',
        text: 'Astronauts have confirmed they can see the Great Wall from space with their eyes.',
    ...
    choices: [
      {
        id: 'a',
        type: 'main-idea',
        text: 'Vaccines train the immune system to fight disease quickly and reduce serious illness.',
        feedback: 'This connects how vaccines work with their overall effect on disease.',
      },
      {
        id: 'b',
        type: 'supporting-detail',
        text: 'Antibodies created by the body remember how to fight one specific germ.',
        feedback: 'True, but this only explains one step in how vaccines work.',
      },
      {
        id: 'c',
        type: 'too-broad',
        text: 'Vaccines have now completely eliminated every dangerous disease around the entire world.',
        feedback: 'The passage says vaccines reduced or eliminated "several" diseases, not all dangerous diseases.',
      },
      {
        id: 'd',
        type: 'unsupported',
        text: 'Vaccines work by injecting a full, active version of a virus or bacteria.',
    ...
    choices: [
      {
        id: 'a',
        type: 'main-idea',
        text: 'Gutenberg\u2019s printing press made books cheaper to produce and helped ideas spread quickly.',
        feedback: 'This connects the invention with its wide-reaching effects described in the passage.',
      },
      {
        id: 'b',
        type: 'supporting-detail',
        text: 'Before the mid-1400s, every book in Europe had to be copied by hand.',
        feedback: 'True, but this only describes the situation before Gutenberg\u2019s invention.',
      },
      {
        id: 'c',
        type: 'too-broad',
        text: 'The printing press is responsible for nearly every major change in modern history.',
        feedback: 'The passage mentions influence on science, religion, and politics, but doesn\u2019t claim it caused every major change.',
      },
      {
        id: 'd',
        type: 'unsupported',
        text: 'Gutenberg\u2019s press made almost every person in Europe literate within just a few years.',
    ...
    choices: [
      {
        id: 'a',
        type: 'main-idea',
        text: 'Wetlands provide several important environmental benefits that often go unnoticed or ignored.',
        feedback: 'This connects the filtering, flood control, and habitat benefits with the warning about their loss.',
      },
      {
        id: 'b',
        type: 'supporting-detail',
        text: 'During storms, wetlands soak up excess water much like a natural sponge.',
        feedback: 'True, but this is only one of the several benefits described.',
      },
      {
        id: 'c',
        type: 'too-broad',
        text: 'Protecting wetlands is considered the single most important job of any government.',
        feedback: 'The passage only discusses wetlands, not the responsibilities of governments in general.',
      },
      {
        id: 'd',
        type: 'unsupported',
        text: 'Most of the wetlands that once existed in the world have already vanished.',
